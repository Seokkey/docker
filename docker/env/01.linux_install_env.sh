...
case ${answer} in
	[yY]|[yY][eE][sS])
		echo >> ~/.bashrc
		echo "PS1='\[\e]0;\w\a\]\n\[\033[32m\][\u@\h:\[\033[34m\]\W\[\033[32m\]]\[\033[00m\]\\$ '" >> /home/$(whoami)/.bashrc
...
tput setaf 4
cat << EOC
Do you want to continue to install virtualbox in linux (Yes/No)?
EOC
...
case ${answer} in
	...
	[nN]|[nN][oO])
		echo "You canceled installing virtualbox";;
esac

echo
tput setaf 4
cat << EOC
Do you want to continue to install cgroup-tools (Yes/No)?
EOC
...
case ${answer} in
	...
	[nN]|[nN][oO])
		echo "You canceled installing cgroup-tools";;
esac